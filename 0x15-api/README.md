...
The project is further practice in working with API's. Data was collected  from the
[JSONPlaceholder REST API](https://jsonplaceholder.typicode.com/), and learnt how
to export the data into  A  CSV or JSON format.
